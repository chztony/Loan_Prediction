...
# Import data sets
titanic_train = pd.read_csv(r'~\OneDrive\Documents\Online Courses\Kaggle Competition'
                            r'\Titanic - Machine Learning from Disaster\train.csv')

titanic_test = pd.read_csv(r'~\OneDrive\Documents\Online Courses\Kaggle Competition'
                           r'\Titanic - Machine Learning from Disaster\test.csv')
...
def output_prediction(model):
    ...
    df_output.to_csv(
         r'~\OneDrive\Documents\Online Courses\Kaggle Competition'
         r'\Titanic - Machine Learning from Disaster\submission_xgboost.csv',
         index=False
    )
